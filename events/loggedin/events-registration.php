...
if(isset($_POST['liftoff-submit'])) {
  	...
  	if(!empty($lfpi) && !empty($lfemail)) {
          ...
          $lfemail = '';
    			...
    			$sql = "SELECT * FROM register WHERE pi = '$lfpi' AND email = '$lfemail'";
    			$run_query = mysqli_query($dbcon, $sql);
    			if(mysqli_num_rows($run_query) > 0) {
              while($row = mysqli_fetch_assoc($run_query)) {
               		$name = $row['name'];
                  ...
                  <p><b>Instructions:</b></p>
                    <ul>
                      ...
                      <p>Put PI Id:</p> 
                       ...
                       <p>Put Email Id:</p>
                       <input type="email" name="lfemail" value="<?php echo $lfemail; ?>" required/><br /><br />
...
if(isset($_POST['hoverpod-submit'])) {
	...
	if(!empty($hppi) && !empty($hpemail)) {
       ...
       $hpemail = '';
			...
			$sql = "SELECT * FROM register WHERE pi = '$hppi' AND email = '$hpemail'";
			$run_query = mysqli_query($dbcon, $sql);
			if(mysqli_num_rows($run_query) > 0) {
            	while($row = mysqli_fetch_assoc($run_query)) {
             		$name = $row['name'];
                  ...
                  <p><b>Instructions:</b></p>
                    <ul>
                      ...
                      <p>Put PI Id:</p> 
                       ...
                       <p>Put Email Id:</p>
                       <input type="email" name="hpemail" value="<?php echo $hpemail; ?>" required/><br /><br />
