...
<?php
   ...
   // echo "<a href='ss-pp-registration.php'>SS-PP-Registration</a>";
   // echo "<p>$pname</p> ";
   // echo "<p>$pemail</p>  ";
   // echo "<p>$pi_admin</p>  ";
...
if(isset($_POST['cases-submit'])) {
  	...
  	if(!empty($cspi) && !empty($csemail)) {
          ...
          $csemail = '';
    			...
    			$sql = "SELECT * FROM register WHERE pi = '$cspi' AND email = '$csemail'";
    			$run_query = mysqli_query($dbcon, $sql);
    			if(mysqli_num_rows($run_query) > 0) {
              while($row = mysqli_fetch_assoc($run_query)) {
               		$name = $row['name'];
                  ...
                  <p><b>Instructions:</b></p>
                    <ul>
                      ...
                      <p>Put PI Id:</p> 
                       ...
                       <p>Put Email Id:</p>
                       <input type="email" name="csemail" value="<?php echo $csemail; ?>" required/><br /><br />
...
if(isset($_POST['space-submit'])) {
	...
	if(!empty($sdpi) && !empty($sdemail)) {
      ...
      $sdemail = '';
			...
			$sql = "SELECT * FROM register WHERE pi = '$sdpi' AND email = '$sdemail'";
			$run_query = mysqli_query($dbcon, $sql);
			if(mysqli_num_rows($run_query) > 0) {
            	while($row = mysqli_fetch_assoc($run_query)) {
             		$name = $row['name'];
                  ...
                  <p><b>Instructions:</b></p>
                    <ul>
                      ...
                      <p>Put PI Id:</p> 
                       ...
                       <p>Put Email Id:</p>
                       <input type="email" name="sdemail" value="<?php echo $sdemail; ?>" required/><br /><br />
...
if(isset($_POST['design-submit'])) {
  ...
  $deemail = $_POST['deemail'];
  if(!empty($depi) && !empty($deemail)) {
    if($depi == $pi_admin) {
      ...
      $sql = "SELECT * FROM register WHERE pi = '$depi' AND email = '$deemail'";
      $run_query = mysqli_query($dbcon, $sql);
      if(mysqli_num_rows($run_query) > 0) {
              while($row = mysqli_fetch_assoc($run_query)) {
                $name = $row['name'];
                  ...
                  <p><b>Instructions:</b></p>
                    <ul>
                      ...
                      <p>Put PI Id:</p> 
                       ...
                       <p>Put Email Id:</p>
                       <input type="email" name="deemail" value="<?php echo $deemail; ?>" required/><br /><br />
