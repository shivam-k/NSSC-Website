...
<div id="myModal1" class="modal-event">
  <div class="modal-content-event">
    ...
    <div class="modal-body-event">
       ...
       <a href="../../payment" style="display: table; margin: 0 auto; text-decoration: none; color: #FFF; background-color: #555; padding: 10px 10px">Make Online Payment</a><br />
     <!-- ============== take participation in lift off ============================= -->

         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
               <input type="submit" value="I want to participate" name="in_lift-off" style="cursor: pointer"/>
         </form>

         <?php
              if(isset($_POST['in_lift-off'])) {
                  $check = "SELECT * FROM register WHERE email = '$pemail'";
                          ...
                          $check = "SELECT * FROM register WHERE liftoff = (SELECT MAX(liftoff) FROM register)";
                           ...
                           if(mysqli_num_rows($result) > 0) {  
                                 while($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  // updating liftoff id of participant in real time colmn liftoff and old time colmn oliftoff 
                                  $sql = "UPDATE register SET liftoff = '$liftoff' WHERE email = '$pemail'";
                                  if(mysqli_query($dbcon, $sql)) {
                                    // echo "<script>alert('Updated register whith liftoff = $liftoff')</script>";
                                  }
                                  ...
                                  if(mysqli_query($dbcon, $insert_lfevent) > 0) {
                                      echo "<script>alert('Your event Id for Lift Off has been generated which is $liftoff. Now you can make your team..');</script>";
                                      ?> <script> window.location="events-registration.php"; </script> <?php
                                   }
                            }
                     }
                     else {
                        echo "<script>alert('You have alredy registered for Lift Off with event id: $liftoff. ');</script>";
                        ?> <script> window.location="events-registration.php"; </script> <?php
                     }  
                  } 
                  else {
                    echo "<script>alert('Your $pemail is not in database....error. not connecting to database')</script>";
                 }
              }
         ?>
  ...
  <div class="modal-content-event">
    ...
    <div class="modal-body-event">
     ...
     <br />
       ...
       <a href="../../payment" style="display: table; margin: 0 auto; text-decoration: none; color: #FFF; background-color: #555; padding: 10px 10px">Make Online Payment</a><br />
        <!-- ============== take participation in Hoverpod ============================= -->

         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
               <input type="submit" value="I want to participate" name="in_hoverpod" style="cursor: pointer"/>
         </form>

         <?php
              if(isset($_POST['in_hoverpod'])) {
                  $check = "SELECT * FROM register WHERE email = '$pemail'";
                  $run = mysqli_query($dbcon, $check);
                  if(mysqli_num_rows($run) > 0) {
                     while($row = mysqli_fetch_assoc($run)) {
                          ...
                          $check = "SELECT * FROM register WHERE hoverpod = (SELECT MAX(hoverpod) FROM register)";
                           ...
                           if(mysqli_num_rows($result) > 0) {  
                                 while($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  // updating liftoff id of participant in real time colmn liftoff and old time colmn oliftoff 
                                  $sql = "UPDATE register SET hoverpod = '$hoverpod' WHERE email = '$pemail'";
                                  if(mysqli_query($dbcon, $sql)) {
                                    // echo "<script>alert('Updated register whith hoverpod = $hoverpod ')</script>";
                                  }
                                  // updating liftoff Id of participant in events table with their PI Id as a admin(Pi1)
                                  $insert = "INSERT INTO hpevent (teamid, pi1, pi2, pi3, pi4, pi5) VALUE ('$hoverpod', '$pi_admin', '', '', '', '')";
                                  if(mysqli_query($dbcon, $insert) > 0) {
                                      echo "<script>alert('Your Event Id for Hoverpod has been generated which is $hoverpod. Now you can make your team..');</script>";
                                      ?> <script> window.location="events-registration.php"; </script> <?php
                                   }
                            }
                     }
                     else {
                        echo "<script>alert('You have alredy registered for Hoverpod with event id: $hoverpod.');</script>";
                        ?> <script> window.location="events-registration.php"; </script> <?php
                     }  
                  } 
                  else {
...
<br />
      ...
      <a href="../../payment" style="display: table; margin: 0 auto; text-decoration: none; color: #FFF; background-color: #555; padding: 10px 10px">Make Online Payment</a><br />
        ...
        <!-- ============== take participation in Rocrun ============================= -->

         
        <!-- ============== take participation in Rocrun ============================= -->

         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
               <input type="submit" value="I want to participate" name="in_rocrun" style="cursor: pointer"/>
         </form>

         <?php
              if(isset($_POST['in_rocrun'])) {
                  $check = "SELECT * FROM register WHERE email = '$pemail'";
                  $run = mysqli_query($dbcon, $check);
                  if(mysqli_num_rows($run) > 0) {
                     while($row = mysqli_fetch_assoc($run)) {
                          ...
                          $check = "SELECT * FROM register WHERE rocrun = (SELECT MAX(rocrun) FROM register)";
                           ...
                           if(mysqli_num_rows($result) > 0) {  
                                 while($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  // updating liftoff id of participant in real time colmn liftoff and old time colmn oliftoff 
                                  $sql = "UPDATE register SET rocrun = '$rocrun' WHERE email = '$pemail'";
                                  if(mysqli_query($dbcon, $sql)) {
                                    // echo "<script>alert('Updated register whith rocrun = $rocrun ')</script>";
                                  }
                                  // updating liftoff Id of participant in events table with their PI Id as a admin(Pi1)
                                  $insert = "INSERT INTO rcevent (teamid, pi1, pi2, pi3, pi4, pi5) VALUE ('$rocrun', '$pi_admin', '', '', '', '')";
                                  if(mysqli_query($dbcon, $insert) > 0) {
                                      echo "<script>alert('Your Event Id for Rocrun has been generated which is $rocrun. Now you can make your team');</script>";
                                      ?> <script> window.location="sp-rc-registration.php"; </script> <?php
                                   }
                            }
                     }
                     else {
                        echo "<script>alert('You have alredy registered for Rocrun with event id: $rocrun. ');</script>";
                        ?> <script> window.location="sp-rc-registration.php"; </script> <?php
                     }  
                  } 
                  else {
...
<a href="http://www.sproboticworks.com/products/" target="_blank" style="display: table; margin: 0 auto; text-decoration: none; color: #FFF; background-color: #555; padding: 10px 10px">Buy Kit Components</a><br />
...
<br />
     ...
     <br />
       ...
       <a href="../../payment" style="display: table; margin: 0 auto; text-decoration: none; color: #FFF; background-color: #555; padding: 10px 10px">Make Online Payment</a><br />
        ...
        <!-- ========================== take participation in Sensorous ============================= -->

         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
               <input type="submit" value="I want to participate" name="in_senso" style="cursor: pointer"/>
         </form>

         <?php
              if(isset($_POST['in_senso'])) {
                  $check = "SELECT * FROM register WHERE email = '$pemail'";
                  $run = mysqli_query($dbcon, $check);
                  if(mysqli_num_rows($run) > 0) {
                     while($row = mysqli_fetch_assoc($run)) {
                          ...
                          $check = "SELECT * FROM register WHERE senso = (SELECT MAX(senso) FROM register)";
                           ...
                           if(mysqli_num_rows($result) > 0) {  
                                 while($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  // updating liftoff id of participant in real time colmn liftoff and old time colmn oliftoff 
                                  $sql = "UPDATE register SET senso = '$senso' WHERE email = '$pemail'";
                                  if(mysqli_query($dbcon, $sql)) {
                                    // echo "<script>alert('Updated register whith senso = $senso ')</script>";
                                  }
                                  // updating liftoff Id of participant in events table with their PI Id as a admin(Pi1)
                                  $insert = "INSERT INTO ssevent (teamid, pi1, pi2, pi3, pi4) VALUE ('$senso', '$pi_admin', '', '', '')";
                                  if(mysqli_query($dbcon, $insert) > 0) {
                                      echo "<script>alert('Your Event Id for Sensorous has been generated which is $senso..Now you can make your team');</script>";
                                      ?> <script> window.location="ss-pp-registration.php"; </script> <?php
                                   }
                            }
                     }
                     else {
                        echo "<script>alert('You have alredy registered for Sensorous with event id: $senso.');</script>";
                        ?> <script> window.location="ss-pp-registration.php"; </script> <?php
                     }  
                  } 
                  else {
  ...
  <div class="modal-content-event">
   ...
   <div class="odd basics">
     ...
     <a href="../../payment" style="display: table; margin: 0 auto; text-decoration: none; color: #FFF; background-color: #555; padding: 10px 10px">Make Online Payment</a><br />
         ...
         <!-- ========================== take participation in Spazor ============================= -->

         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
               <input type="submit" value="I want to participate" name="in_spazor" style="cursor: pointer"/>
         </form>

         <?php
              if(isset($_POST['in_spazor'])) {
                  $check = "SELECT * FROM register WHERE email = '$pemail'";
                  $run = mysqli_query($dbcon, $check);
                  if(mysqli_num_rows($run) > 0) {
                     while($row = mysqli_fetch_assoc($run)) {
                          ...
                          $check = "SELECT * FROM register WHERE spazor = (SELECT MAX(spazor) FROM register)";
                           ...
                           if(mysqli_num_rows($result) > 0) {  
                                 while($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  // updating liftoff id of participant in real time colmn liftoff and old time colmn oliftoff 
                                  $sql = "UPDATE register SET spazor = '$spazor' WHERE email = '$pemail'";
                                  if(mysqli_query($dbcon, $sql)) {
                                    // echo "<script>alert('Updated register whith senso = $senso ')</script>";
                                  }
                                  // updating liftoff Id of participant in events table with their PI Id as a admin(Pi1)
                                  ...
                                  if(mysqli_query($dbcon, $insert) > 0) {
                                      echo "<script>alert('Your Event Id for Spazor has been generated which is $spazor. Now you can make your team..');</script>";
                                      ?> <script> window.location="sp-rc-registration.php"; </script> <?php
                                   }
                            }
                     }
                     else {
                        echo "<script>alert('You have alredy registered for Spazor with event id: $spazor. ');</script>";
                        ?> <script> window.location="sp-rc-registration.php"; </script> <?php
                     }  
                  } 
                  else {
         ...
         ?>
          ...
          <div style="text-align:center"><a href="http://nssc.in/eventtut/pdf/spazor.pdf" target="_blank"><h4 style="color: black">Download the tutorial</h4></a></div>    <br />  
...
<a href="../../payment" style="display: table; margin: 0 auto; text-decoration: none; color: #FFF; background-color: #555; padding: 10px 10px">Make Online Payment</a><br />
         ...
         <div style="text-align:center"><h3 style="color: black">Stay tuned for more updates</h3></div>      
...
<a href="../../payment" style="display: table; margin: 0 auto; text-decoration: none; color: #FFF; background-color: #555; padding: 10px 10px">Make Online Payment</a><br />
      <!-- ========================== take participation in Space Deb ============================= -->

         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
               <input type="submit" value="I want to participate" name="in_space" style="cursor: pointer"/>
         </form>

         <?php
              if(isset($_POST['in_space'])) {
                  $check = "SELECT * FROM register WHERE email = '$pemail'";
                  $run = mysqli_query($dbcon, $check);
                  if(mysqli_num_rows($run) > 0) {
                     while($row = mysqli_fetch_assoc($run)) {
                          ...
                          $check = "SELECT * FROM register WHERE space = (SELECT MAX(space) FROM register)";
                           ...
                           if(mysqli_num_rows($result) > 0) {  
                                 while($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  // updating liftoff id of participant in real time colmn liftoff and old time colmn oliftoff 
                                  $sql = "UPDATE register SET space = '$space' WHERE email = '$pemail'";
                                  if(mysqli_query($dbcon, $sql)) {
                                    // echo "<script>alert('Updated register whith senso = $senso ')</script>";
                                  }
                                  // updating liftoff Id of participant in events table with their PI Id as a admin(Pi1)
                                  $insert = "INSERT INTO sdevent (teamid, pi1, pi2, pi3) VALUE ('$space', '$pi_admin', '', '')";
                                  if(mysqli_query($dbcon, $insert) > 0) {
                                      echo "<script>alert('Your Event Id for Space Deb has been generated which is $space. Now you can make your team..');</script>";
                                      ?> <script> window.location="cs-sd-de-registration.php"; </script> <?php
                                   }
                            }
                     }
                     else {
                        echo "<script>alert('You have alredy registered for Space Deb with event id: $space. ');</script>";
                        ?> <script> window.location="cs-sd-de-registration.php"; </script> <?php
                     }  
                  } 
                  else {
  ...
  <div class="modal-content-event">
   ...
   <div class="odd basics">
     ...
     <a href="../../payment" style="display: table; margin: 0 auto; text-decoration: none; color: #FFF; background-color: #555; padding: 10px 10px">Make Online Payment</a><br />
          ...
          <!-- ========================== take participation in Designeer ============================= -->

         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
               <input type="submit" value="I want to participate" name="in_design" style="cursor: pointer"/>
         </form>

         <?php
              if(isset($_POST['in_design'])) {
                  $check = "SELECT * FROM register WHERE email = '$pemail'";
                  $run = mysqli_query($dbcon, $check);
                  if(mysqli_num_rows($run) > 0) {
                     while($row = mysqli_fetch_assoc($run)) {
                          ...
                          $check = "SELECT * FROM register WHERE design = (SELECT MAX(design) FROM register)";
                           ...
                           if(mysqli_num_rows($result) > 0) {  
                                 while($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  // updating liftoff id of participant in real time colmn liftoff and old time colmn oliftoff 
                                  $sql = "UPDATE register SET design = '$design' WHERE email = '$pemail'";
                                  if(mysqli_query($dbcon, $sql)) {
                                    // echo "<script>alert('Updated register whith senso = $senso ')</script>";
                                  }
                                  // updating liftoff Id of participant in events table with their PI Id as a admin(Pi1)
                                  $insert = "INSERT INTO deevent (teamid, pi1, pi2, pi3) VALUE ('$design', '$pi_admin', '', '')";
                                  if(mysqli_query($dbcon, $insert) > 0) {
                                      echo "<script>alert('Your Event Id for Designeer has been generated which is $design. Now You can make your team..');</script>";
                                      ?> <script> window.location="cs-sd-de-registration.php"; </script> <?php
                                   }
                            }
                     }
                     else {
                        echo "<script>alert('You have alredy registered for Designeer with event id: $design. ');</script>";
                        ?> <script> window.location="cs-sd-de-registration.php"; </script> <?php
                     }  
                  } 
                  else {
...
<a href="../../payment" style="display: table; margin: 0 auto; text-decoration: none; color: #FFF; background-color: #555; padding: 10px 10px">Make Online Payment</a><br />
        ...
        <!-- ========================== take participation in Case Study ============================= -->

         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
               <input type="submit" value="I want to participate" name="in_cases" style="cursor: pointer"/>
         </form>

         <?php
              if(isset($_POST['in_cases'])) {
                  $check = "SELECT * FROM register WHERE email = '$pemail'";
                  $run = mysqli_query($dbcon, $check);
                  if(mysqli_num_rows($run) > 0) {
                     while($row = mysqli_fetch_assoc($run)) {
                          ...
                          $check = "SELECT * FROM register WHERE cases = (SELECT MAX(cases) FROM register)";
                           ...
                           if(mysqli_num_rows($result) > 0) {  
                                 while($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  // updating liftoff id of participant in real time colmn liftoff and old time colmn oliftoff 
                                  $sql = "UPDATE register SET cases = '$cases' WHERE email = '$pemail'";
                                  if(mysqli_query($dbcon, $sql)) {
                                    // echo "<script>alert('Updated register whith senso = $senso ')</script>";
                                  }
                                  // updating liftoff Id of participant in events table with their PI Id as a admin(Pi1)
                                  $insert = "INSERT INTO csevent (teamid, pi1, pi2, pi3, pi4) VALUE ('$cases', '$pi_admin', '', '', '')";
                                  if(mysqli_query($dbcon, $insert) > 0) {
                                      echo "<script>alert('Your Event Id for Case Study has been generated which is $cases. Now you can make your team..');</script>";
                                      ?> <script> window.location="cs-sd-de-registration.php"; </script> <?php
                                   }
                            }
                     }
                     else {
                        echo "<script>alert('You have alredy registered for Case Study with event id: $cases.');</script>";
                        ?> <script> window.location="cs-sd-de-registration.php"; </script> <?php
                     }  
                  } 
                  else {
...
<a href="../../payment" style="display: table; margin: 0 auto; text-decoration: none; color: #FFF; background-color: #555; padding: 10px 10px">Make Online Payment</a><br />
                 ...
                 <!-- ========================== take participation in Paper Presentation ============================= -->

         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
               <input type="submit" value="I want to participate" name="in_paper" style="cursor: pointer"/>
         </form>

         <?php
              if(isset($_POST['in_paper'])) {
                  $check = "SELECT * FROM register WHERE email = '$pemail'";
                  $run = mysqli_query($dbcon, $check);
                  if(mysqli_num_rows($run) > 0) {
                     while($row = mysqli_fetch_assoc($run)) {
                          ...
                          $check = "SELECT * FROM register WHERE paper = (SELECT MAX(paper) FROM register)";
                           ...
                           if(mysqli_num_rows($result) > 0) {  
                                 while($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  // updating liftoff id of participant in real time colmn liftoff and old time colmn oliftoff 
                                  $sql = "UPDATE register SET paper = '$paper' WHERE email = '$pemail'";
                                  if(mysqli_query($dbcon, $sql)) {
                                    // echo "<script>alert('Updated register whith senso = $senso ')</script>";
                                  }
                                  // updating liftoff Id of participant in events table with their PI Id as a admin(Pi1)
                                  ...
                                  if(mysqli_query($dbcon, $insert) > 0) {
                                      echo "<script>alert('Your Event Id for Paper Presentation has been generated which is $paper.. You can make your team..');</script>";
                                      ?> <script> window.location="ss-pp-registration.php"; </script> <?php
                                   }
                            }
                     }
                     else {
                        echo "<script>alert('You have alredy registered for Paper Presentation with event id: $cases. ');</script>";
                        ?> <script> window.location="ss-pp-registration.php"; </script> <?php
                     }  
                  } 
                  else {
